...
class UserOngoingProject extends StatefulWidget {
  const UserOngoingProject({Key? key,required this.auth}) : super(key: key);
  final AuthBase auth;

  @override
  State<UserOngoingProject> createState() => _UserOngoingProjectState();
}

class _UserOngoingProjectState extends State<UserOngoingProject> {
