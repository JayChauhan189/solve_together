...
class UserCompletedProject extends StatefulWidget {
  const UserCompletedProject({Key? key,required this.auth}) : super(key: key);
  final AuthBase auth;

  @override
  State<UserCompletedProject> createState() => _UserCompletedProjectState();
}

class _UserCompletedProjectState extends State<UserCompletedProject> {
          ...
          StreamBuilder<DocumentSnapshot>(
            ...
            builder: (BuildContext context,
              ...
              for (var name in itemDetailList) {
                ...
                if (checkstatus == "completed" && flag == 1) {
